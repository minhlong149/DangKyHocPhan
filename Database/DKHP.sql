...
CREATE TABLE MONHOC(
	...
	TenMaMon VARCHAR(5) NOT NULL,
	TenMon NVARCHAR(40) NOT NULL,
	SoTiet INT NOT NULL,
	LoaiMon VARCHAR(5) FOREIGN KEY REFERENCES LOAIMON(MaLoaiMon) NOT NULL,
	NguoiTao NVARCHAR(40),
	NgayTao DateTime,
	NguoiCapNhat NVARCHAR(40),
	NgayCapNhat DateTime,
)

SET IDENTITY_INSERT MONHOC ON

INSERT INTO MONHOC VALUES (1,'SS007', N'Triết học Mác – Lênin', 12, 'LT', '','','','');
INSERT INTO MONHOC VALUES ('2', 'MA005', N'Xác suất thống kê', 13, 'LT');
INSERT INTO MONHOC VALUES ('3', 'IT001', N'Nhập môn lập trình', 14, 'TH');
INSERT INTO MONHOC VALUES ('4', 'IT002', N'Lập trình hướng đối tượng', 14, 'TH');
INSERT INTO MONHOC VALUES ('5', 'IE106', N'Thiết kế giao diện người dùng', 14, 'LT');
INSERT INTO MONHOC VALUES ('6', 'IS334', N'Thương mại điện tử', 11, 'TH');
INSERT INTO MONHOC VALUES ('7', 'SE114', N'Nhập môn ứng dụng di động', 13, 'TH');
...
CREATE TABLE CHUONGTRINH(
	...
	HocKy INT,
	MonHoc INT FOREIGN KEY REFERENCES MONHOC(MAMON),
	GhiChu VARCHAR(40),
...
CREATE TABLE THUHOCPHI(
	...
	SoPhieu VARCHAR(15) FOREIGN KEY REFERENCES PHIEUDK (SoPhieu) NOT NULL,
	SoTienThu INT NOT NULL,
	NgayThu DATE NOT NULL 
)
INSERT INTO THUHOCPHI VALUES ('','000112022',2500,CURRENT_TIMESTAMP);

DROP TABLE MONHOC;
DROP TABLE PHIEUDK;
DROP TABLE MONHOCMO;
DROP TABLE DKHOCPHAN;
