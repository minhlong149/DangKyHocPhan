...
CREATE TABLE CHUAHTHP(
	SoPhieu VARCHAR(15) PRIMARY KEY FOREIGN KEY REFERENCES PHIEUDK (SoPhieu),
...
SELECT CHUAHTHP.SoPhieu, HocKy, NamHoc, CHUAHTHP.MaSV, SoTienDangKy, SoTienPhaiDong, SoTienConLai
